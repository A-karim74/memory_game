...
function shuffleAnArray(array) {
    ...
    console.log("log sortie Shuffle");
    console.table(images_links);
//  on crée des li unique pour chaque card 

images_links.forEach((image_link) => { 
 const li_Tags = document.createElement('li');
 li_Tags.classList.add('card')
 
const image =document.createElement("img")
image.setAttribute("src", image_link);
image.setAttribute('alt' , "Fruix card");
image.setAttribute('draggable' , "false");
  image.classList.add('card');
li_Tags.append(image);
board_game_container.append(li_Tags);
});
